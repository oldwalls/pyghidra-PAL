...
def main():
    ...
    local_24 = 0
    while 4 >= local_24:
        v_2683 = transform_a((local_2c + local_24))
        if v_2683 & 1 == 0 or (1 < local_24 and v_2683 < 500):
            local_20 = 0
            while local_20 < 3:
                v_2704 = transform_b((local_24 + local_20))
                v_1460 = (v_2704 % 4)
                if v_1460 == 2:
                    if local_2c < 201:
                    ...
                    if v_2704 % 4 >= 3:
                        ...
                        if v_2704 % 4 == 0:
                            local_2c = (local_2c + (v_2704 ^ 0x12))
                            local_20 = (local_20 + 1)
                        else:
                            if v_2704 % 4 == 1:
                                v_2712 = check_bit(local_2c, 3)
                                if v_2712 == 0:
                                    local_2c = transform_a(local_2c)
                                    local_20 = (local_20 + 1)
                                else:
                                    local_2c = (local_2c + 0xfffffffb)
                                    local_20 = (local_20 + 1)
                            else:
                                local_2c = (local_2c << 1)
                                local_20 = (local_20 + 1)
            ...
            local_1c = 0
            while local_1c < 2:
                if v_5848 >> (local_1c & 31) & 1 == 0:
                    local_2c = (local_2c + (v_5848 >> 2))
                    local_1c = (local_1c + 1)
                else:
