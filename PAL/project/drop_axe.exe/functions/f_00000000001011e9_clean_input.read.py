...
# Ghidra function: Global::clean_input
# Entry address: 0x1011e9
...
def clean_input(param_0):
    abi_context = ABI.current('function_entry:1053161')
    v_133 = strcspn(param_0, 0x102008)
    v_80 = (param_0 + (v_133 * 1))
    MEM8[v_80] <- 0
    return 0
