...
from PALhelpers import c_bits, c_ptradd, c_return_bits, c_store

def clean_input(param_0):
    abi_context = c_abi_context('function_entry:1053161')
    v_133 = c_bits(c_abi_call(abi_context, 'strcspn', (param_0, 0x102008), plan_id='call_site:1053165:(ram, 0x10120a, 24, 1):1'), 64)
    v_80 = c_ptradd(param_0, v_133, 1, 64)
    c_store(MEM, v_80, 0, 8)
