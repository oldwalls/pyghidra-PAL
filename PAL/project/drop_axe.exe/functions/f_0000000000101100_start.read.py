...
def _start(param_0, param_1):
    abi_context = ABI.current('function_entry:1052928')
    ...
    v_337 = (0 - 0x10121c)
    PTR___libc_start_main_00103fd8(v_337, param_1, v_33, 'GCC: (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0', 'GCC: (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0', param_0, v_66)
    while True:
        pass
