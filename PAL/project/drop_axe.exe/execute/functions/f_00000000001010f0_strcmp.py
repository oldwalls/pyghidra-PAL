...
def strcmp(param_0, param_1):
    abi_context = c_abi_context('function_entry:1052912')
    v_16 = c_bits(c_abi_call(abi_context, PTR_strcmp_00103fd0, (), plan_id='call_site:1052916:(ram, 0x1010f4, 0, 2):2'), 32)
    return c_abi_return(abi_context, v_16, 32, (('register', 'EAX', 32, 'register:0:4'),), plan_id='function_entry:1052912')
