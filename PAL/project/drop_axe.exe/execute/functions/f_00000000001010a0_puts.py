...
def puts(param_0):
    abi_context = c_abi_context('function_entry:1052832')
    v_15 = c_bits(c_abi_call(abi_context, PTR_puts_00103fa8, (), plan_id='call_site:1052836:(ram, 0x1010a4, 0, 2):2'), 32)
    return c_abi_return(abi_context, v_15, 32, (('register', 'EAX', 32, 'register:0:4'),), plan_id='function_entry:1052832')
