...
# Ghidra function: <EXTERNAL>::uselocale
# Entry address: 0x1025c0
...
def uselocale(param_0):
    abi_context = ABI.current('function_entry:1058240')
    v_34 = PTR_uselocale_0010bef0()
    return v_34
