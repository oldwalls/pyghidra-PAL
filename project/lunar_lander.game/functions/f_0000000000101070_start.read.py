...
def _start(param_0, param_1):
    abi_context = ABI.current('function_entry:1052784')
    ...
    v_337 = (0 - 0x1016f0)
    PTR___libc_start_main_00103fc0(v_337, param_1, v_33, 'GCC: (Debian 14.2.0-19) 14.2.0', 'GCC: (Debian 14.2.0-19) 14.2.0', param_0, v_66)
    while True:
        pass
