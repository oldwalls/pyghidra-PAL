...
def puts(param_0):
    ...
    v_15 = c_bits(c_abi_call(abi_context, PTR_puts_00104000, (), plan_id='call_site:1052720:(ram, 0x101030, 0, 2):2'), 32)
    return c_abi_return(abi_context, v_15, 32, (('register', 'EAX', 32, 'register:0:4'),), plan_id='function_entry:1052720')
