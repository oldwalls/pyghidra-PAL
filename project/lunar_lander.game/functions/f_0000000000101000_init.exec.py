...
def _init(param_0):
    ...
    v_212 = 0
    if not c_ne(c_load(MEM, 1064912, 64), 0, 64):
        pass
    else:
        v_212 = c_bits(c_abi_call(abi_context, PTR___gmon_start___00103fd0, (), plan_id='call_site:1052688:(ram, 0x101010, 23, 2):2'), 32)
