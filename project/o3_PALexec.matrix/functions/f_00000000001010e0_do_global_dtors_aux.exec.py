...
def __do_global_dtors_aux():
    ...
    if not c_eq(c_load(MEM, 1064976, 8), 0, 8):
        ...
        if not c_ne(c_load(MEM, 1064952, 64), 0, 64):
            ...
            c_abi_call(abi_context, '__cxa_finalize', (c_load(MEM, 0x104008, 64),), plan_id='call_site:1052923:(ram, 0x101102, 30, 3):3')
        c_abi_call(abi_context, 'deregister_tm_clones', (), plan_id='call_site:1052935:(ram, 0x101107, 33, 6):6')
        return c_return_bits(0, 64)
